...
- 使用 MEMORY.md 中定义的标准模板格式
- 包含市场背景（通过 `memory_search` 查询）

### 周度回顾（每周日 20:00）

- 写入 `memory/YYYY-MM-DD-weekly.md`
- 从本周的日期文件中提取市场事件和决策记录
- 评估决策质量
- **给出具体操作建议**
- 更新 MEMORY.md 的「投资洞察」部分（如果有新的规律）

### 月度分析（每月 1 日 20:00）

- 写入 `memory/YYYY-MM-monthly.md`
- 从本月的周度回顾中提取关键信息
- 分析长期趋势
- **给出策略调整建议**
- 更新 MEMORY.md 的「当前投资组合」和「投资洞察」部分
